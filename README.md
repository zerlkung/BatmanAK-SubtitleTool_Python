...
#### 5. OrbisTOC.txt (PS4)
หลัง mod ขนาดไฟล์จะเปลี่ยน — ถ้าเกม PS4 reject ไฟล์ ให้แก้ไข `OrbisTOC.txt` เปลี่ยน size ของไฟล์ที่แก้ไขเป็นค่า max (`7014993920`)

#### 6. ไฟล์ compressed ปนใน folder
...
#### 5. OrbisTOC.txt (PS4)
After modding, file sizes change. If PS4 rejects the files, edit `OrbisTOC.txt` and set the size of each modified file to the max value (`7014993920`).

#### 6. Compressed files mixed in folder
